"""Injection detection and PII extraction/separation.

Enforces CLAUDE.md rule 3 (CV text is DATA, wrapped in <document> delimiters,
never treated as instructions) and rule 5 (no personal identifiers reach the
LLM during matching).
"""
...
_STAGE2_CONTEXT_CHARS = 800
_SPAN_CONTEXT_RADIUS = 40
